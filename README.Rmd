---
title: "ARU data processing on BirdNET for Birds Canada (east)"
#author: "Sunny Tseng"
#date: "`r Sys.Date()`"
...
-   Species by location tab
    ...
    -   week: based on recording time, calculated by this [date calculater](https://www.timeanddate.com/date/weeknumber.html)
-   Inference settings
...
-   All the BirdNET output files can be found [HERE](./data/cleaned), and the processing schedule section includes details for individual ARU sites.

-   One excel file was produced for each site, each ARU, with the following naming rule: `site_location_aruid.csv`
